      ...
      '<div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:26px;">' +
        '<div>' +
          ...
          '<div style="display:flex; flex-direction:column; gap:11px;">' +
            ...
            '<div style="display:flex; gap:11px; align-items:flex-start;"><span class="badge" style="background:#D98A00; color:#fff; margin-top:1px;">Warning</span><div style="font-family:\'Crimson Pro\',Georgia,serif; font-size:12.5px; line-height:1.5; color:#3c4156;">Virulence factor found; follow-up may not be necessary.</div></div>' +
