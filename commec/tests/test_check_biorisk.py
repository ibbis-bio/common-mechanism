...
@pytest.mark.parametrize(
    "annotations_exists, has_empty_or_no_output, has_hits, expected_return",
    [
...
def test_check_biorisk_return_codes(annotations_exists, has_empty_or_no_output, has_hits, expected_return):
    ...
    with (
        ...
        patch("commec.screeners.check_biorisk.HmmerHandler.has_empty_or_no_output", return_value=has_empty_or_no_output),
