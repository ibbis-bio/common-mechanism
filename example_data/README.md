...
* **addgene-plasmid-36399** (`FLAG`): This plasmid from addgene contains many fragments from Vesiculovirus, a commonly controlled organism from many jurisdictions.
