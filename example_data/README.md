...
* **addgene-plasmid-111773** (`FLAG`): This is the [pGEMT-PTE2A plasimd from addgene](https://www.addgene.org/111773/), which contains 2A sequences from three different organisms, including one from Porcine Teschovirus (P2A), which is controlled by a wide variety of lists under various terms.
